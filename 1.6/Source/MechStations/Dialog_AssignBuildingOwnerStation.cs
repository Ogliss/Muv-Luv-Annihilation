...
{
	public class Dialog_AssignBuildingOwnerStation : Window
	{
		private CompMechSuitAssignableToStation assignable;
		...
		public Dialog_AssignBuildingOwnerStation(CompMechSuitAssignableToStation assignable)
		{
			...
			try
			{
				...
				foreach (MechStation assigningCandidate in assignable.AssigningCandidates)
				{
					if (assignable.assignedStation == null || assignable.assignedStation != assigningCandidate)
					{
						...
						{
							assignable.TryAssignStation(assigningCandidate);
