...
namespace OgsOld_ExtraHives
{
	...
	public abstract class LordToil_HiveRelated : LordToil
	{
		...
		private Hive FindClosestHive(Pawn pawn)
		{
			...
			bool pawnDefaultFaction = pawn.kindDef.defaultFactionDef != null;
			FactionDef factionDef = pawnFaction ? pawn.Faction.def : (pawnDefaultFaction ? pawn.kindDef.defaultFactionDef : null);
