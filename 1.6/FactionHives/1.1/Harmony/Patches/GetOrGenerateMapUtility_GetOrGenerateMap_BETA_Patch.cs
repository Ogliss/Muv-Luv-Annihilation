...
namespace OgsOld_ExtraHives.HarmonyInstance
{
    ...
    new Type[] { typeof(PlanetTile), typeof(IntVec3), typeof(WorldObjectDef), typeof(IEnumerable<GenStepWithParams>), typeof(bool) })]
    public static class GetOrGenerateMapUtility_GetOrGenerateMap_MapSize_Patch
    {
        public static void Prefix(PlanetTile tile, ref IntVec3 size, WorldObjectDef suggestedMapParentDef)
        {
