...
namespace OgsOld_ExtraHives
{
	...
	public class IncidentWorker_InfestedMeteoriteImpact : IncidentWorker
	{
		...
		private bool TryFindCell(out IntVec3 cell, Map map)
		{
			...
			return CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.InfestedMeteoriteIncoming_OgsOld_ExtraHives, map, ThingDefOf.InfestedMeteoriteIncoming_OgsOld_ExtraHives.terrainAffordanceNeeded, out cell, 10, default(IntVec3), -1, true, false, false, false, true, true, delegate (IntVec3 x)
			{
