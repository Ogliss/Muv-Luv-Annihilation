	...
	public class IncidentWorker_CrashedShip : IncidentWorker
	{
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			for (int i = 0; i < countToSpawn; i++)
			{
				...
				IntVec3 intVec;
				bool flag2 = !CellFinderLoose.TryFindSkyfallerCell(thingDef, map, thingDef.terrainAffordanceNeeded, out intVec, 14, default(IntVec3), -1, false, true, true, true, true, false, null);
				if (flag2)
				{
					break;
				}
