...
{
	// 1168 OgsOld_CompTurret.Verb_ShootCompMounted
	public class Verb_ShootCompMounted : Verb_LaunchProjectile
	{
		...
		public OgsOld_CompTurret turret;
		public OgsOld_CompTurretGun turretGun => turret as OgsOld_CompTurretGun ?? ReloadableCompSource as OgsOld_CompTurretGun;
		...
		public new OgsOld_CompTurret ReloadableCompSource
		{
			get
			{
				return this.DirectOwner as OgsOld_CompTurret;
			}
		}
		...
		public override bool TryCastShot()
		{
			...
			if (f)
			{
                ...
                shootLine.ChangeDestToMissWild(shotReport.AimOnTargetChance_StandardTarget, flyOverhead, caster.Map);
