...
namespace OgsOld_CompTurret
{
	...
	public class Command_OgsOld_CompTurretReloadable : Command_VerbTarget
	{
		...
		public override bool GroupsWith(Gizmo other)
		{
			...
			Command_OgsOld_CompTurretReloadable command_Reloadable = other as Command_OgsOld_CompTurretReloadable;
			return command_Reloadable != null && this.comp.parent.def == command_Reloadable.comp.parent.def;
		}

		// Token: 0x04003007 RID: 12295
		private readonly OgsOld_CompTurret comp;
