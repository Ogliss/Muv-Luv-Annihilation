...
namespace OgsOld_CompTurret
{
	...
	public class OgsOld_CompTurretGun : OgsOld_CompTurret
	{
		...
		public OgsOld_CompTurretGun()
		{
			this.top = new OgsOld_CompTurretTop(this);
		}
		...
		*/
		public override void PostDraw()
		{
			if (Operator != null)
			{
				if (this.Props.drawTurret)
				{
					if (this.top == null)
					{
						top = new OgsOld_CompTurretTop(this);
					}
					if (this.top != null)
					{
						this.top.DrawTurret();
		...
		public override void PostDrawExtraSelectionOverlays()
		{
			...
			if (this.forcedTarget.IsValid && (!this.forcedTarget.HasThing || this.forcedTarget.Thing.Spawned))
			{
				...
				a.y = vector.y;
				GenDraw.DrawLineBetween(a, vector, OgsOld_CompTurretGun.ForcedTargetLineMat);
			}
		}
		...
		public override IEnumerable<Gizmo> CompGetWornGizmosExtra()
		{
			...
			*/
			...
			if (flag && (Operator.Faction == Faction.OfPlayer || (Prefs.DevMode && DebugSettings.godMode)))
			{
				...
				CommandTex = ContentFinder<Texture2D>.Get(Props.iconPath, true);
				yield return new Command_ToggleOgsOld_CompTurret(this)
				{
			...
			{
				num += 100;
				Command_OgsOld_CompTurretVerbTarget command_VerbTarget = new Command_OgsOld_CompTurretVerbTarget();
		...
		public Thing gun;
		protected OgsOld_CompTurretTop top;
