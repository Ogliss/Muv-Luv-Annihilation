...
namespace MuvLuvBeta.HarmonyInstance
{
	...
	public static class FloatMenuMakerMap_AddHumanlikeOrders_Test_Patch
	{
        public static void Postfix(Vector3 clickPos, Pawn pawn, ref List<FloatMenuOption> opts)
        {

			IntVec3 c = IntVec3.FromVector3(clickPos);
			foreach (Pair<CompApparel_Turret, Thing> pair in CompTurretReloadableUtility.FindPotentiallyReloadableGear(pawn, c.GetThingList(pawn.Map)))
			{
				CompApparel_Turret comp = pair.First;
