...
namespace MuvLuvBeta
{
	...
	public class Command_TSFReloadable : Command_VerbTarget
	{
		// Token: 0x06005671 RID: 22129 RVA: 0x001CE6CF File Offset: 0x001CC8CF
		public Command_TSFReloadable(CompApparel_Turret comp)
		{
			this.comp = comp;
		}
		...
		public override bool GroupsWith(Gizmo other)
		{
			...
			Command_TSFReloadable command_Reloadable = other as Command_TSFReloadable;
			return command_Reloadable != null && this.comp.parent.def == command_Reloadable.comp.parent.def;
		}

		// Token: 0x04003007 RID: 12295
		private readonly CompApparel_Turret comp;
