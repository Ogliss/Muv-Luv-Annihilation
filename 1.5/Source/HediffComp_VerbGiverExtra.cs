...
namespace MuvLuvAnnihilation
{
    ...
    public class HediffCompProperties_VerbGiverBETA : HediffCompProperties_VerbGiver
    {
        // Token: 0x06004C81 RID: 19585 RVA: 0x00239AA6 File Offset: 0x00237EA6
        public HediffCompProperties_VerbGiverBETA()
        {
            this.compClass = typeof(HediffComp_VerbGiverBETA);
        }
    ...
    public class HediffComp_VerbGiverBETA : HediffComp_VerbGiver, IVerbOwner
    {
        public int tickLastUsed = -1;
        // Token: 0x06004C85 RID: 19589 RVA: 0x00239F45 File Offset: 0x00238345
        public HediffComp_VerbGiverBETA()
        {
        ...
        public new HediffCompProperties_VerbGiverBETA Props
        {
            get
            {
                return (HediffCompProperties_VerbGiverBETA)this.props;
            }
        }
        ...
        public new List<VerbProperties> VerbProperties
        {
            get
            {
                ...
                foreach (VerbProperties Entry in Props.verbs)
                {
                    VerbProperties.Add(Entry);
                }
