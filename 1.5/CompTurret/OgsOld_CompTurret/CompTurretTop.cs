...
{
	public class OgsOld_CompTurretTop
	{
			...
			if (this.parentTurret.stunTicksLeft > 0)
			{
				...
				*/
				...
				if (this.parentTurret.AffectedByEMP && this.parentTurret.stunFromEMP)
				{
					...
					{
						this.parentTurret.empEffecter = new EffecterComp(DefDatabase<EffecterDef>.GetNamed("OgsOld_CompTurretDisabledByEMP"));
					}
		...
		{
			MoteOgsOld_CompTurretAttached mote = (MoteOgsOld_CompTurretAttached)ThingMaker.MakeThing(ThingDef.Named("Mote_OgsOld_CompTurretStun"), null);
		...
		public void DrawTurret()
		{
			...
			Quaternion quart = (this.CurRotation + (float)OgsOld_CompTurretTop.ArtworkRotation).ToQuat();
		...
		private OgsOld_CompTurret parentTurret;
		private OgsOld_CompTurretGun parentTurretGun => parentTurret as OgsOld_CompTurretGun;
